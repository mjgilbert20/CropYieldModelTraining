...
This project uses the **NOAA Daily Weather Observations** data from the [Databricks Marketplace](https://marketplace.databricks.com/). This large-scale dataset provides comprehensive historical weather data to train and validate the yield prediction models.
